<div class="typography">
    <div id="Content">
        ...
        <form action="$CurrentSubsite.SagePayURL" method="POST" id="SagePayForm" name="SagePayForm"> 
            <input type="hidden" name="navigate" value="" />
            <input type="hidden" name="VPSProtocol" value="2.23" />
            <input type="hidden" name="TxType" value="PAYMENT" />
            <input type="hidden" name="Vendor" value="$CurrentSubsite.SagePayVendor" />
            <input type="hidden" name="Crypt" value="$CryptData" />
            
            
            <a href="javascript:history.go(-1)" class="button"><% _t('Commerce.BACK','Back') %></a>
